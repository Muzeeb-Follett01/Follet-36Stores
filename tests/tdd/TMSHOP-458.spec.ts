...
// ── Test Suite ────────────────────────────────────────────────────────────────
test.describe("TMSHOP-458: E2E014 | FMS Standalone - User Account (Creation and Update)", () => {
  test.skip(!isEnabled("TMSHOP-458"), "Skipped via Excel execute flag");
   ...
   */
  test("E2E014 | FMS Standalone - User Account (Creation and Update)", async ({
    page,
  }, testInfo) => {
    const loginPage = new FollettLoginPage(page, "TMSHOP-458");
    const productPage = new FollettProductPage(page, "TMSHOP-458");
    const checkoutPage = new FollettCheckoutPage(page, "TMSHOP-458");
